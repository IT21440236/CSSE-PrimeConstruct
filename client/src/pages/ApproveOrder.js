...
export const ApproveOrder = () => {
    ...
    const updateorder = async (e) => {
        ...
        const { siteName, supplier, placedDate, requiredDate, productName, productQty, orderstatus } = inpval;

        if (!siteName || !supplier || !placedDate || !requiredDate || !productName || !productQty || !orderstatus) {
